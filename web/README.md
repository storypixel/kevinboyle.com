...
1.  Run the build command:
    ...
    npm run build
    ```
2.  This generates a `dist` folder containing the optimized files ready for deployment to platforms like [Vercel](https://vercel.com/) or [Netlify](https://www.netlify.com/).
